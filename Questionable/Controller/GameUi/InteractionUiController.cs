...
internal sealed class InteractionUiController : IDisposable
{
    ...
    {
        AddonSelectString* addonSelectString = (AddonSelectString*)(IntPtr)args.Addon;
    ...
    {
        AddonCutSceneSelectString* addonCutSceneSelectString = (AddonCutSceneSelectString*)(IntPtr)args.Addon;
    ...
    {
        AddonSelectIconString* addonSelectIconString = (AddonSelectIconString*)(IntPtr)args.Addon;
    ...
    {
        AddonSelectYesno* addonSelectYesno = (AddonSelectYesno*)(IntPtr)args.Addon;
    ...
    {
        AtkUnitBase* addonDifficultySelectYesNo = (AtkUnitBase*)(IntPtr)args.Addon;
    ...
    {
        AtkUnitBase* addonPointMenu = (AtkUnitBase*)(IntPtr)args.Addon;
        PointMenuPostSetup(addonPointMenu);
    }
